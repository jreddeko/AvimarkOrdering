...
uses
  IdMessage,
  IdAttachmentFile, Wddc.Inventory.Order, Wddc.Inventory.Item, Data.DBXJSONCommon,
...
begin
  ...
  try
    ...
    LConfig.smtpPort := 25;
    LConfig.smtpAuthType := IdSmtp.TIdSMTPAuthenticationType.satNone;
    ...
    LConfig.Save;
    Lconfig := LConfig.Open;
    Assert.IsTrue(LConfig.smtpHost = 'xcgsrv13.wddcho.com');
    Assert.IsTrue(LConfig.smtpPort = 25);
    Assert.IsTrue(LConfig.smtpAuthType = IdSmtp.TIdSMTPAuthenticationType.satNone);
